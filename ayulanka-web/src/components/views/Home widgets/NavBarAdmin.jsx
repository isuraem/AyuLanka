  ...
  return (
    <Container>
      <Wrapper>
        ...
        <Left>
        <MenuItem><button type="button" class="btn btn-outline-danger" onClick={() => { history.push("/allFeedback"); window.location.reload() }}><b>FeedBacks</b></button></MenuItem>
        <MenuItem><button type="button" class="btn btn-outline-danger" onClick={() => { history.push("/viewAllB"); window.location.reload() }}><b>Buyers</b></button></MenuItem>
