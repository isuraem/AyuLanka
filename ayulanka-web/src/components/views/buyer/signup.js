  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://mysoreayurveda.in/wp-content/uploads/2020/10/jar.jpg)",
      ...
      >
        <div className="container" style={{ textAlign: "start" }}>
          <div className="p-5  col-lg-10 col-xl-7 flex-row mx-auto px-0">
            {/* <div className="ms-auto me-auto pt-4 pb-4 mt-3  shadow-sm" style={{ backdropFilter: "blur(5px)", backgroundColor: "rgba(275, 275, 275, 0.550)", borderRadius: "15px" }}> */}
            {/* <Header></Header> */}
            ...
            <Card
              ...
              className="p-5 ms-auto me-auto pt-4 pb-3 mt-3  shadow-sm"
            >
              <Card.Header>
